...
import {v1} from "uuid";
import {addTodolistActionType, removeTodolistActionType, todolistId1, todolistId2} from "./to-do-lists-reducer";
...
export const tasksReducer = (state = initionalState, action: kingActionType): TasksStateType => {
    switch (action.type) {
        case "DELETE-TASK": {
